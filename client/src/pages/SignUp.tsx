  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        ...
        description: "We'll contact you shortly at the email you provided.",
      });
    },
    onError: (error: Error) => {
      toast({
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-6">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Your request has been received. Our team will contact you shortly at the email address you provided.
            </CardDescription>
          </CardHeader>
      ...
      <div className="container max-w-md mx-auto px-6 py-20">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              We're preparing to launch Cingila. Sign up now to be among the first to experience
